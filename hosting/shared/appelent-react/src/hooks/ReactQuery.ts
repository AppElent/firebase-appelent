...
import { useMutation as useMutationDefault, UseMutationResult } from 'react-query';
...
export const useQuery = (
    queryKey: QueryKey,
    queryFn?: QueryFunction | QueryOptionsExtended,
    queryOptions?: QueryOptionsExtended,
): QueryObserverResult => {
